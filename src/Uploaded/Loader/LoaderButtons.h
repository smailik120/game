#ifndef _LOADERBUTTONS_H
#define _LOADERBUTTONS_H
#include <list>
#include <string>
#include <cstring>
#include <utility>
...
class LoaderButtons {
 public:
    const int buttonUp = 119;
    const int buttonLeft = 97;
    const int buttonDown = 115;
    const int buttonRight =100;
    const int buttonInventory = 105;
    map<int, ButtonAction*>* load();
};
#endif